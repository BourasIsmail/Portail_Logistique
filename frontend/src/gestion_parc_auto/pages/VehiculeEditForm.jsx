...
export default function VehiculeForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await updateVehicule(vehiculeId, dataToSend);
  ...
  if (!vehiculeData)
    return (
      <div className="p-8 text-center text-red-500">
        Données du véhicule non trouvées.
      </div>
    );
          ...
          <CardContent className="p-8 space-y-10">
            ...
            <section className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div className="space-y-2">
                  <Label htmlFor="referenceMarche">Référence Marché</Label>
                  <Input
                    id="referenceMarche"
                    name="referenceMarche"
                    value={vehiculeData.referenceMarche}
                    onChange={handleChange}
                  />
                </div>
              </div>
            ...
            <section className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    value={
                      vehiculeData.chauffeurAttitreId?.toString() || "none"
                    }
                    onValueChange={(v) =>
