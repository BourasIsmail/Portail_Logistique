...
export default function VehiculeForm() {
    ...
    const [vehiculeData, setVehiculeData] = useState({
        immatriculation: '', marque: '', modele: '', genre: '', typeCarburant: 'DIESEL',
                ...
                <Card className="max-w-5xl mx-auto border-gray-300 shadow-lg">
                    ...
                    <CardContent className="p-8 space-y-10">
                        ...
                        <section className="space-y-4">
                            <div className="flex items-center space-x-3"><Car className="h-6 w-6 text-blue-600" /><h3 className="text-xl font-semibold text-gray-700">Identification</h3></div>
                        ...
                        <section className="space-y-4">
                            <div className="flex items-center space-x-3"><Wrench className="h-6 w-6 text-green-600" /><h3 className="text-xl font-semibold text-gray-700">Détails Techniques</h3></div>
                        ...
                        {/* Section 3: Affectation et Statut */}
                         <section className="space-y-4">
                            <div className="flex items-center space-x-3"><Users className="h-6 w-6 text-purple-600" /><h3 className="text-xl font-semibold text-gray-700">Affectation et Statut</h3></div>
                             <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                         ...
                         <section className="space-y-4">
                            <div className="flex items-center space-x-3"><Info className="h-6 w-6 text-orange-600" /><h3 className="text-xl font-semibold text-gray-700">Informations Complémentaires</h3></div>
